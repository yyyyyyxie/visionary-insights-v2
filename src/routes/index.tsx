          ...
          <div className="space-y-14">
            ...
            <Section id="papers" number="02" title="Paper Reading：可控性">
              ...
              <div id="multicoin" className="scroll-mt-24">
                <Card accent>
                  ...
                  <ImagePlaceholder src="/images/paper_reading/5.png" caption="图 5：方法对比" ratio="16/9" originalCaption="Comparison with Framer. Top row shows reduced trajectory distortion. Bottom rows demonstrate the benefits of additional controls, including depth and text guidance." />
                </Card>
              </div>
              ...
              <div id="palette" className="scroll-mt-24">
                <Card accent>
                  ...
                  <H3>为什么用调色板控制是个复杂问题？</H3>
                  <p>
                    直接把调色板当变长 RGB 序列输入，模型极难稳定训练——潜空间方差太大。
                    <strong>核心解法是</strong>：把调色板映射为固定大小的 3D HSV 直方图（34×12×10 = 4080 bins），
            ...
            <Section id="textflux" number="04" title="TextFlux：多语言场景文本合成">
              <Card highlight>
                ...
                <ImagePlaceholder src="/images/textflux/0.png" caption="可视化样例" ratio="16/9" originalCaption="Some examples of high-fidelity multilingual scene text images generated by our TextFlux." />
                <p>
                ...
                <ImagePlaceholder src="/images/textflux/arch.png" caption="模型架构" ratio="16/9" originalCaption="Overview of TextFlux. We propose an OCR-free scene text synthesis method that spatially concatenates glyph-rendered text with
the original image as model input, enabling the diffusion transformer to leverage its inherent context-awareness to render text in the masked
regions." />
                </Callout>
                ...
                <H3>与商业模型对比：优势明显（去年投稿时期）</H3>
                <ImagePlaceholder src="/images/textflux/2.png" caption="高危场景文本数据合成示例" ratio="16/9" originalCaption="Comparison of our method TextFlux with commercial image generation models: GPT-Image-1, Nano banana, and Qwen-
Image-Edit. GPT-Image-1 shows poor consistency and may modify text outside the desired editing area. Nano banana exhibits significant
limitations with non-Latin languages. Qwen-Image-Edit performs well in English and Chinese but demonstrates clear limitations in localization
and other non-Latin languages. TextFlux demonstrates leading performance in scene text synthesis." />
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-2">
                  <ControlPill label="颜色" paper="Palette" targetId="palette" />
                  <ControlPill label="运动 & 区域" paper="MultiCOIN" targetId="multicoin" />
                  <ControlPill label="Glyph & Layout" paper="TextFlux" targetId="textflux" />
